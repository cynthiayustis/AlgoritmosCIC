...
class Nodo: #definición de la clase
  conexiones = list() #declaración de variable global para la clase Nodo
  grado = 0
...
class Arista: #definición de la clase 
  ancestro = None #declaración de variable global para la clase Arista
  descendiente = None #declaración de variable global para la clase Arista
...
class Grafo:
  ...
  #el número de nodos totales del grafo final serán la multiplicación de n*m
  def Malla(n,m):
      ...
      Grafo.GuardarMatriz("Malla",aristas,str(n*m))
      return aristas
...
lista1 = Grafo.Malla(5,6)   
lista2 = Grafo.ErdosRenyi(30,90)
lista3 = Grafo.Gilbert(30,0.4) 
lista4 = Grafo.Geografico(30,0.5)
lista5 = Grafo.BarabasiAlbert(30,3)
lista6 = Grafo.Dorogovtsev_Mendes(30)

lista7 = Grafo.Malla(10,10)   
lista8 = Grafo.ErdosRenyi(100,150)
lista9 = Grafo.Gilbert(100,0.4) 
lista10 = Grafo.Geografico(100,0.5)
lista11 = Grafo.BarabasiAlbert(100,3)
lista12 = Grafo.Dorogovtsev_Mendes(100)

lista13 = Grafo.Malla(25,20)   
lista14 = Grafo.ErdosRenyi(500,700)
lista15 = Grafo.Gilbert(500,0.4) 
lista16 = Grafo.Geografico(500,0.5)
lista17 = Grafo.BarabasiAlbert(500,3)
lista18 = Grafo.Dorogovtsev_Mendes(500)
